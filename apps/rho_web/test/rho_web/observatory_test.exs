defmodule RhoWeb.ObservatoryTest do
  @moduledoc """
  Tests for RhoWeb.Observatory GenServer -- metrics collection, diagnostics, and signal processing.
  """

  use ExUnit.Case, async: false

  alias RhoWeb.Observatory
