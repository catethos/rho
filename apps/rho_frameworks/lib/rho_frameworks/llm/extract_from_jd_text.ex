defmodule RhoFrameworks.LLM.ExtractFromJDText do
  @moduledoc """
  BAML-backed extractor for plain-text job descriptions.
  """

  use RhoBaml.Function,
    client: "OpenRouterHaiku",
    params: [jd_text: :string]
  ...
  @skill_schema Zoi.map(%{
                  ...
                  source_quote:
                    ...
                    |> Zoi.optional(),
                  page_number:
                    Zoi.integer(description: "1-based page number when inferable.")
                    |> Zoi.optional()
                })
