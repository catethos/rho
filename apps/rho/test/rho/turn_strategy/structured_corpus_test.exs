defmodule Rho.TurnStrategy.StructuredCorpusTest do
  ...
  future change to `Rho.TurnStrategy.Structured` can be weighed against
  ...
  describe "structured strategy baseline on real corpus" do
    test "structured dispatches over the corpus and records heuristic totals" do
      totals =
        Enum.reduce(@fixtures, {0, 0}, fn fixture, {s_h, s_r} ->
          ...
          s = TurnStrategyHarness.run(Structured, text, tools)
